...
import { Wallet, Calendar, ShieldOff } from "lucide-react";
...
export default function CreatorTermsPage() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
      <BackButton label="Back" fallbackHref="/settings/payout" />
      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-[220px_1fr]">
        ...
        <div className="flex flex-col gap-9">
          ...
          <div className="border-t border-hairline pt-6">
            <BackButton
              label="Back to payout settings"
              fallbackHref="/settings/payout"
