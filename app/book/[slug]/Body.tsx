        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <Link
                href={`/book/${book.slug}/chapter/${chapters[0]?._id ?? ""}`}
            ...
            <Link href={`/u/${book.author.username}`} className="mt-5 flex items-center gap-3 rounded-xl border border-hairline bg-surface p-3">
              {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div className="pt-2 lg:pt-8">
            ...
            {/* Reviews */}
            {/* Reviews — replaces the old static block */}
